...
namespace AtlyssArchipelagoWIP
{
    public class PortalUnlocks : MonoBehaviour
    {
        ...
        public void ApplyAreaAccessMode()
        {
            ...
            // Lock portal scenes that have progressive portal counts > 0
            ...
            // These areas have portal_count 0 in Python, meaning progressive mode
            // doesn't gate them (quest requirements in Regions.py handle access instead).
            // Only lock them in random portal mode where individual portal items exist.
            if (basePlugin.randomPortalsEnabled)
            {
                BlockAccessToScene("Assets/Scenes/00_zone_forest/_zone00_gateOfTheMoon.unity");
                BlockAccessToScene("Assets/Scenes/00_zone_forest/_zone00_wallOfTheStars.unity");
                BlockAccessToScene("Assets/Scenes/map_zone00_redwoud.unity");
                BlockAccessToScene("Assets/Scenes/00_zone_forest/_zone00_trialOfTheStars.unity");
            }
        }
